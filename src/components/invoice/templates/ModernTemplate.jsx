...
export const ModernTemplate = React.forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      {/* Header with border */}
      <div className="flex justify-between items-start mb-10 border-b border-gray-900 pb-4">
        <div className="w-1/2">
          {sender.logo ? (
            <img
              src={sender.logo}
        ...
        <div className="text-right">
          ...
          <p className="text-sm text-gray-400 mt-1">Date: {details.date}</p>
          {details.dueDate && (
            <p className="text-sm text-gray-400">Due: {details.dueDate}</p>
          )}
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-y  border-gray-900">
              <th className="text-left py-3 font-semibold text-sm uppercase tracking-wide text-gray-700">
                Description
              </th>
              <th className="text-center py-3 font-semibold text-sm uppercase tracking-wide text-gray-700 w-20">
                Qty
              </th>
              <th className="text-right py-3 font-semibold text-sm uppercase tracking-wide text-gray-700 w-28">
                Rate
              </th>
              <th className="text-right py-3 font-semibold text-sm uppercase tracking-wide text-gray-700 w-32">
                Amount
              </th>
            </tr>
          </thead>
